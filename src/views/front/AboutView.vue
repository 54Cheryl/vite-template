      ...
      <div class="container py-5">
        <div class="row">
          ...
          <div class="tel-use mt-2">
            <div class="d-flex my-4 col-md-2" data-aos="fade-zoom-in" data-aos-easing="ease-in-sine" data-aos-delay="500" data-aos-offset="0">
            ...
            <div class="col-12 col-md-auto my-auto p-0" data-aos="fade-zoom-in" data-aos-easing="ease-in-sine" data-aos-delay="500" data-aos-offset="0">
          ...
          <div class="col-lg-6 col-md-10 p-0 d-flex justify-content-evenly position-relative appeal-top" style="max-height: 450px; height: 55vh; z-index: 2;">
            <div class="mx-4 col-md-auto">
              <div class="d-flex position-relative" data-aos="fade-zoom-in" data-aos-easing="ease-in-sine" data-aos-offset="0">
                ...
                <span class="text-center fs-7 Serif-TC writing-lr mt-3 neutral-900" data-aos="fade-zoom-in" data-aos-easing="ease-in-sine" data-aos-offset="0" data-aos-delay="100">Brand Appeal</span>
              </div>
    ...
    <div class="bg-sec other-use">
      <div class="container py-5">
        <div class="row justify-content-evenly my-5 position-relative">
          <div class="col-lg-6 col-md-10 my-auto p-0 position-relative biechaer-img" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
            <img src="https://storage.googleapis.com/vue-course-api.appspot.com/cheryl-hexschool/1678902302593.jpg?GoogleAccessId=firebase-adminsdk-zzty7%40vue-course-api.iam.gserviceaccount.com&Expires=1742169600&Signature=THH5yaOyGS8LsgFFP9VoyagU8eUgtOQptlrCChUGkjWWiqJiWx29xMfDFm0viyMhM3Uo9BFTtvJ3RPe6Sf7ieK48nLuXRLIe6ZsdKJ6P41m7HgMhswA4Ciq%2F6onEojS6O%2F9FMqWrAjdfQTNBxufFNt%2F1fRiF0%2B89xWtsvLiXFD2P1bh8IfzZU01xZKETWJF4H0pqDhGlQq0uZNJ622vT3Xlj%2BNOBsqiipwwtQ3XS6uXjo29CRcRW96wRt3JV0K%2BEWCmkwWD89DVdczcJMNsWiPD9n5Hf9GhrFFIHZRkSnGu35nH65uPRmpSmVV1iroxN0%2BrvTSvucf1Lolu5nW%2BXqw%3D%3D" alt="" class="img-fluid">
          </div>
          <div class="col-lg-6 col-md-10 p-0 d-flex justify-content-evenly position-relative appeal-top" style="max-height: 450px; height: 55vh; z-index: 2;">
            <div class="col-md-auto bg-opacity-80 writing-lr my-4" data-aos="fade-zoom-in" data-aos-easing="ease-in-sine" data-aos-delay="200" data-aos-offset="0">
              <p class="letter-spacing Sans-TC neutral-300 mb-0 mt-4 writing-rl" data-aos="fade-zoom-in" data-aos-easing="ease-in-sine" data-aos-delay="500" data-aos-offset="0">擁有超過二十年的茶席經驗，並且曾受邀前往日本、德國等地推廣茶文化，以專業的品評技巧，創造出獨具特色的品茶體驗。透過「茶乾香、茶湯味、杯底香」的細膩層次感受，深刻地展現出台灣茶的美妙向度，其中的芬芳則源自土壤、雨水以及製茶師的手藝。憑藉對茶葉的熱情與堅持，她將引領您探索不同種類的茶葉風味，讓您品味茶葉的多種層次。</p>
              <p class="letter-spacing Sans-TC neutral-700 fs-5 mt-4" data-aos="fade-zoom-in" data-aos-easing="ease-in-sine" data-aos-delay="400" data-aos-offset="0">首席品茶師 Chris</p>
            </div>
            <div class="mx-4 col-md-auto">
              <div class="d-flex position-relative" data-aos="fade-zoom-in" data-aos-easing="ease-in-sine" data-aos-offset="0">
                <img src="https://storage.googleapis.com/vue-course-api.appspot.com/cheryl-hexschool/1678657173971.png?GoogleAccessId=firebase-adminsdk-zzty7%40vue-course-api.iam.gserviceaccount.com&Expires=1742169600&Signature=MHd4mGdFGGnSsP3GSFLQgsEvfMKifxctn3GQ1CEIU0aYouK%2FDr3MraqmFSb8Kfgf6kVLn9R%2BIpITyDkjrM%2FcoTtyhCvARZDUOEcG3MSnHESIp%2FtH6Iutscaa1UKCtMLg9XyVtAgqUv08h%2FjYlRiSdbr8mzWrlFuTbPth3J8NJaRa51BlW5WiIGFwgzuDr2DqtbhcAuJyYmm5N642IXaALlXAhvoGBhSX0MB5xp4ITp2fI%2BZE0wxP9ANdTCp%2BbrQz2zStXlNu71VJTLfAGn4eL28yl8qriMAJZKi1mRxsXcTdjKLiK%2BZjKpb9HXaiaKBME0oAi7JzB3oDyJGMB9qC3A%3D%3D" alt="" class="position-absolute" style="right: 0.5rem; top: -0.2rem;">
                <h3 class="letter-spacing Serif-TC mt-3 mx-0 writing-lr neutral-900">別茶品茶師
                </h3>
                <span class="fs-7 Serif-TC writing-lr neutral-900" style="margin-top: 2.5rem;" data-aos="fade-zoom-in" data-aos-easing="ease-in-sine" data-aos-offset="0" data-aos-delay="100">Tea Taster</span>
              </div>
              <p class="bg-n500 m-auto" style="width: 1px; height: 15vh;" data-aos="fade-zoom-in" data-aos-easing="ease-in-sine" data-aos-offset="0" data-aos-delay="200"></p>
            </div>
          </div>
