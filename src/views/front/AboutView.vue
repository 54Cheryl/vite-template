<template>
  ...
  <div class="bg-all" style="padding-top: 90px; padding-bottom: 6vh;">
    <div class="position-relative d-flex align-items-center justify-content-center" style="min-height: 180px;">
      ...
      <h2 class="fw-bold Serif-TC letter-spacing position-relative text-white mb-0">關於別茶</h2>
    </div>
    <!-- 第一屏-手機 -->
          ...
          <div class="col-lg-6 col-md-10 p-0 d-flex justify-content-evenly position-relative appeal-top" style="max-height: 450px; height: 55vh; z-index: 2;">
            ...
            <div class="mx-4 col-md-auto">
              <div class="d-flex position-relative">
                ...
                <span class="fs-7 Serif-TC writing-lr neutral-900" style="margin-top: 2.5rem;">Tea Taster</span>
              </div>
              <p class="bg-n500 m-auto" style="width: 1px; height: 15vh;"></p>
            </div>
          </div>
