  ...
  <div class="bg-sec" style="padding-top: 90px; padding-bottom: 4vh;">
    ...
    <div class="container pb-5 pt-4">
      <div class="row py-4 px-0">
          ...
          <div class="d-flex" style="max-height: 40vh;">
            <div class="ms-4 ps-5">
              <div class="d-flex position-relative" data-aos="fade-zoom-in" data-aos-easing="ease-in-sine" data-aos-offset="0">
                ...
                <span class="text-left fs-7 Serif-TC writing-lr mt-4 pt-4 neutral-900" data-aos="fade-zoom-in" data-aos-easing="ease-in-sine" data-aos-offset="0" data-aos-delay="100">News</span>
              </div>
        ...
        <div class="row col-md-9 d-flex justify-content-left pt-5 m-auto" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
