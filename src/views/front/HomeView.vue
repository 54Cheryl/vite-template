<template>
  ...
  <div class="container">
    <div class="row pb-4 pt-5 px-0 justify-content-evenly">
      <div class="tel-use" data-aos="fade-zoom-in" data-aos-easing="ease-in-sine" data-aos-delay="500" data-aos-offset="0">
