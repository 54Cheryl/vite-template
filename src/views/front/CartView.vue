<template>
  ...
  <div class="" style="padding-top: 90px; padding-bottom: 6vh;">
    ...
    <div class="container">
      <div class="row justify-content-center pt-5 px-lg-4 px-2 mx-lg-5">
      ...
      <div class="row justify-content-between px-4 mx-lg-5" style="padding-top: 4vh;">
        ...
        <button type="button" class="btn btn-custom Serif-TC letter-spacing col-6 col-md-auto" @click="checkCartNum">確認訂單</button>
      </div>
    </div>
  </div>
