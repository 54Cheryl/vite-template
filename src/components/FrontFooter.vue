<template>
  <footer class="bg-footer py-1 Sans-TC">
    <p class="text-center text-white pt-3">此網站僅做為前端 side project 作品練習，不做商業用途，請勿用於商業用途，謝謝!</p>
    <div class="d-flex justify-content-center opacity-50">
      ...
      <p class="text-center text-white"> Copyright Ⓒ 2023 Made by Cheryl｜</p>
